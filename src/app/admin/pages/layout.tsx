"use client"
import { AppSidebar } from "@/components/adminComponents/Navbar";
        ...
        <main className="flex-1 flex flex-col">
          <nav className="bg-zinc-900 text-white shadow-lg flex items-center p-4 sticky top-0 z-10">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/admin/pages/profilepage" className="p-2">
                    ...
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        ...
                        <div className="flex justify-around items-center m-3">
                          <Button variant={'destructive'} onClick={logoutfeature}>Logout</Button>
