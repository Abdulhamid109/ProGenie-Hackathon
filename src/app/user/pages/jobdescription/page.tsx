  ...
  return (
    <div>
      <div className='bg-zinc-700 p-3 rounded-md bg-gradient-to-l from-black/[0.96] mb-2'>
        ...
        <h1 className='font-light text-sm p-2 flex gap-2'><span>{data.jobSkills}</span><b>Vacancy</b>:{data.jobVacancy}<span></span></h1>
      </div>
      <div className='bg-zinc-700 p-3 rounded-md bg-gradient-to-l from-black/[0.96] mb-2'>
        <div className='font-bold text-2xl text-shadow-2xs p-2'>Job Description</div>
        <div className='font-light text-lg tracking-tight p-2'>
          {data.jobdescription}
      </div>
      </div>
      <div className='bg-zinc-700 p-3 rounded-md bg-gradient-to-l from-black/[0.96] '>
        <div className='font-bold text-2xl text-shadow-2xs p-2'>
          About Company
        </div>
        <div className='font-light text-lg tracking-tight p-2'>
          {data.AboutCompany}
